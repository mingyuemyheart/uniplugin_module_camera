    ...
    private void parseInitRsp(String rspString) {
        ...
        try {
            ...
            CosXmlServiceConfig cosXmlServiceConfig = new CosXmlServiceConfig.Builder()
                    ...
                    .build();
            cosService = new CosXmlService(context, cosXmlServiceConfig, new TVCDirectCredentialProvider(cosTmpSecretId, cosTmpSecretKey, cosToken, cosExpiredTime));
